...
class AssignTypeAction : public action_handler_t {
public:
    static constexpr const char *ACTION_NAME = "IDAZeta:AssignTypeAction"; // action 标识
    static constexpr const char *NAME_IN_MENU = "set type";                // 右键菜单中的名称
    static constexpr const char *TOOLTIP_IN_MENU = "set type";             // 右键菜单中的悬浮提示
    static constexpr const char *SHORTCUT = "Shift+Y";
